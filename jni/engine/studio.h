...
#define MAXSTUDIOSKINS		4096	// total textures
#define MAXSTUDIOSRCBONES		4096	// bones allowed at source movement
#define MAXSTUDIOBONES		4096	// total bones actually used
#define MAXSTUDIOMODELS		4096	// sub-models per model
#define MAXSTUDIOBODYPARTS		4096	// body parts per submodel
#define MAXSTUDIOGROUPS		4096	// sequence groups (e.g. barney01.mdl, barney02.mdl, e.t.c)
#define MAXSTUDIOANIMATIONS		512	// max frames per sequence
#define MAXSTUDIOMESHES		256	// max textures per model
#define MAXSTUDIOEVENTS		4096	// events per model
