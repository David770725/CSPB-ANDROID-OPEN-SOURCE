...
{
case 1:
EMIT_SOUND(pEntity->edict(), CHAN_ITEM, "debris/WM_Shotgun_Hit_Wood_1.wav", 0.7, ATTN_NORM);
break;

case 2:
EMIT_SOUND(pEntity->edict(), CHAN_ITEM, "debris/WM_Shotgun_Hit_Ground_1.wav", 0.7, ATTN_NORM);
break;

case 3:
EMIT_SOUND(pEntity->edict(), CHAN_ITEM, "debris/WM_Shotgun_Hit_Metal_1.wav", 0.7, ATTN_NORM);
break;
}
...
{
case 1:
EMIT_SOUND(pEntity->edict(), CHAN_ITEM, "debris/WM_Hit_GrazeBullet_1.wav", 0.7, ATTN_NORM);
break;

case 2:
EMIT_SOUND(pEntity->edict(), CHAN_ITEM, "debris/WM_Hit_GrazeBullet_2.wav", 0.7, ATTN_NORM);
break;

case 3:
EMIT_SOUND(pEntity->edict(), CHAN_ITEM, "debris/WM_Hit_GrazeBullet_3.wav", 0.7, ATTN_NORM);
break;
}
...
/*            if (IsPlayer())
            {
                // adjust tracer position for player
                vecTracerSrc = vecSrc + Vector(0, 0, -4) + gpGlobals->v_right + gpGlobals->v_forward * 16;
            }
            else
            {
                vecTracerSrc = vecSrc;
