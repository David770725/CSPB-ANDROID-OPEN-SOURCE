...
class CScar_carbine : public CBasePlayerWeapon
{
public:
	void Spawn() override;
...
public:
	void Scar_carbineFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);

public:
	int m_iShell;

private:
	unsigned short m_usFireScar_carbine;
};
