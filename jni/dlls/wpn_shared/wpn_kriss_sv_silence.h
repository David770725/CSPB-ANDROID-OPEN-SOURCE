...
#endif
//kriss silencer
class CKriss_sv_silence : public CBasePlayerWeapon
{
public:
	void Spawn() override;
...
public:
	void Kriss_sv_silenceFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);
	float GetDamage();
...
public:
	...
	int iShellOn;
private:
	unsigned short m_usFireKriss_sv_silence;
};
#endif
