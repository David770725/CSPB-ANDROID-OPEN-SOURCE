...
class CKriss_sv_dual_crb : public CBasePlayerWeapon
{
public:
	void Spawn() override;
...
public:
	void Kriss_sv_dual_crbFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);
	float GetDamage();
...
private:
	unsigned short m_usFireKriss_sv_dual_crb;
};
