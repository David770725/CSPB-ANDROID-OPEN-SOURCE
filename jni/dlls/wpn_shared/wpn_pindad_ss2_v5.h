...
class CPindad_ss2_v5 : public CBasePlayerWeapon
{
public:
	void Spawn() override;
...
public:
	void Pindad_ss2_v5Fire(float flSpread, float flCycleTime, BOOL fUseAutoAim);

	int m_iShell;
	int iShellOn;

private:
	unsigned short m_usFirePindad_ss2_v5;
};
