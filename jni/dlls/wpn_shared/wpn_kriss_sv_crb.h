...
class CKriss_sv_crb : public CBasePlayerWeapon
{
public:
	void Spawn() override;
...
public:
	void Kriss_sv_crbFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);
	float GetDamage();
...
int m_iSprBeam;
private:
	unsigned short m_usFireKriss_sv_crb;
};
