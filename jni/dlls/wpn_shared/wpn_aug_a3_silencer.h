...
class CAug_a3_silencer : public CBasePlayerWeapon
{
public:
	void Spawn() override;
...
public:
	void Aug_a3_silencerFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);

	int m_iShell;
	int iShellOn;

private:
	unsigned short m_usFireAug_a3_silencer;
};
