...
class CTactilite_t2 : public CBasePlayerWeapon
{
public:
	void Spawn() override;
...
public:
	void Tactilite_t2Fire(float flSpread, float flCycleTime, BOOL fUseAutoAim);

	int m_iShell;

private:
	unsigned short m_usFireTactilite_t2;
};
