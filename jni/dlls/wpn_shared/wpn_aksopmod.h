...
class CAKSOPMOD : public CBasePlayerWeapon
{
public:
	void Spawn() override;
...
public:
	void AKSOPMODFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);

	int m_iShell;
	int iShellOn;

private:
	unsigned short m_usFireAKSOPMOD;
};


//cg
class CAKSOPMOD_CG : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	void Precache() override;
