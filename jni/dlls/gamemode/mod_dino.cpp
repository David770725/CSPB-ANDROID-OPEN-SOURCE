...
void CMod_Dino::CheckMapConditions()
{
...
void CMod_Dino::UpdateGameMode(CBasePlayer *pPlayer)
{
...
BOOL CMod_Dino::ClientConnected(edict_t *pEntity, const char *pszName, const char *pszAddress, char *szRejectReason)
{
...
void CMod_Dino::ClientDisconnected(edict_t *pClient)
{
...
void CMod_Dino::CheckWinConditions()
{
...
int CMod_Dino::IPointsForKill(CBasePlayer *pAttacker, CBasePlayer *pKilled)
{
...
void CMod_Dino::PlayerKilled(CBasePlayer *pVictim, entvars_t *pKiller, entvars_t *pInflictor)
{
...
void CMod_Dino::InstallPlayerModStrategy(CBasePlayer *player)
{
...
CPlayerModStrategy_ZB1::CPlayerModStrategy_ZB1(CBasePlayer *player, CMod_Dino *mp)
...
void CMod_Dino::HumanInfectionByZombie(CBasePlayer *player, CBasePlayer *attacker)
{
...
void CMod_Dino::InfectionSound()
{
	for(CBasePlayer *player : moe::range::PlayersList())
		CLIENT_COMMAND(player->edict(), "spk zombi_coming_%d\n", RANDOM_LONG(1, 2));
}

void CMod_Dino::RestartRound()
{
	for(CBasePlayer *player : moe::range::PlayersList())
...
void CMod_Dino::PlayerSpawn(CBasePlayer *pPlayer)
{
...
BOOL CMod_Dino::FPlayerCanTakeDamage(CBasePlayer *pPlayer, CBaseEntity *pAttacker)
{
	int iReturn = FALSE;
